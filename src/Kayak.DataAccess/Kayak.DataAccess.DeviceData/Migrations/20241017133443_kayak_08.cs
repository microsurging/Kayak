...
{
    public partial class kayak_08 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "Physical_PropertyThreshold",
                columns: table => new
                {
                    ...
                    ThresholdLevel = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Physical_PropertyThreshold", x => x.Id);
                });
        }
